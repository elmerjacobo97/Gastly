      ...
      <CardHeader>
        <div className="flex items-start justify-between gap-2">
          <div>
            ...
            <CardDescription>
              Top categorías del período · {categories.length}{" "}
              {label.toLowerCase()}
            </CardDescription>
          </div>
          <SegmentedControl
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Recurrentes vs variables en el período
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex h-40 items-center justify-center text-sm text-muted-foreground">
    ...
    <Card>
      ...
      <CardContent className="flex flex-col gap-5">
        ...
        <div className="rounded-lg bg-muted/40 p-3 text-xs text-muted-foreground">
          {recurringCount} pago{recurringCount !== 1 ? "s" : ""} recurrente
          {recurringCount !== 1 ? "s" : ""} · {variableCount} gasto
          {variableCount !== 1 ? "s" : ""} variable
          {variableCount !== 1 ? "s" : ""}
        </div>
      </CardContent>
    </Card>
