      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <Card size="sm">
          <CardHeader>
            ...
            <CardAction>
              <div
                className={`grid size-8 shrink-0 place-items-center rounded-lg ${unassigned >= 0 ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400" : "bg-destructive/10 text-destructive"}`}
              >
          ...
          <CardContent>
            <p
              className={`text-lg font-semibold tabular-nums ${unassigned >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-destructive"}`}
            >
        ...
        <Card size="sm">
          <CardHeader>
            ...
            <CardAction>
              <div
                className={`grid size-8 shrink-0 place-items-center rounded-lg ${remaining >= 0 ? "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400" : "bg-destructive/10 text-destructive"}`}
              >
          ...
          <CardContent>
            <p
              className={`text-lg font-semibold tabular-nums ${remaining >= 0 ? "text-emerald-600 dark:text-emerald-400" : "text-destructive"}`}
            >
