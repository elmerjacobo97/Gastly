...
export function LoansSummaryCards({ loans }: LoansSummaryCardsProps) {
  ...
  return (
    <div className="grid gap-3 sm:grid-cols-3">
      <Card size="sm">
        <CardHeader>
          <CardTitle className="text-xs font-medium text-muted-foreground">Me deben</CardTitle>
          <CardAction>
      ...
      <Card size="sm">
        <CardHeader>
          <CardTitle className="text-xs font-medium text-muted-foreground">Debo</CardTitle>
          <CardAction>
      ...
      <Card size="sm">
        ...
        <CardContent>
          <p className="text-xs text-muted-foreground">{isNetPositive ? "A tu favor" : "Por moneda"}</p>
