...
import { ensureGastlyDir, getGastlyDir } from "./config.js"
import type { GastlySession } from "./types.js"
...
export function parseSession(value: unknown): GastlySession {
...
export async function readSession(): Promise<GastlySession | null> {
  try {
...
export async function writeSession(session: GastlySession): Promise<string> {
