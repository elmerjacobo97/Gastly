...
export function EditTransactionDialog({
  ...
  const defaults = useMemo(
    () => ({
      ...
      creditCardDueOn: creditCardDueOn ?? "",
    }),
    [
      type,
      amount,
  ...
  return (
    <>
      <QuickCreateCategoryDialog
        ...
        onCreated={(_id, name) =>
          form.setValue("categoryName", name, { shouldValidate: true })
        }
      />
              ...
              >
                <FieldGroup>
                  ...
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      <Field data-invalid={fieldState.invalid}>
                        <FieldLabel htmlFor="et-description">
                          Descripción
                        </FieldLabel>
                        <Input
                          {...field}
                  ...
                  {transaction.type === "expense" && (
                    <>
                      <Controller
                        ...
                        render={({ field }) => (
                          <Field>
                            <FieldLabel htmlFor="et-payment-method">
                              Método de pago
                            </FieldLabel>
                            <NativeSelect
                              {...field}
                              className="w-full"
                              id="et-payment-method"
                            >
                              <NativeSelectOption value="cash">
                                Efectivo / Débito
                              </NativeSelectOption>
                              <NativeSelectOption value="credit_card">
                                Tarjeta de crédito
                              </NativeSelectOption>
                            </NativeSelect>
                          </Field>
