  ...
  return (
    <Card className="w-full max-w-md border-foreground/10 text-center shadow-xl shadow-foreground/5">
      <CardHeader className="items-center">
        ...
        <CardDescription>Te enviamos un enlace para activar tu cuenta.</CardDescription>
      </CardHeader>
      <CardContent>
        <p className="text-sm leading-6 text-muted-foreground">
          Revisa {params.email ? <span className="font-medium text-foreground">{params.email}</span> : 'tu correo'} y
          abre el enlace de confirmacion. Al confirmarlo, volveras a Gastly con tu sesion iniciada.
        </p>
      </CardContent>
